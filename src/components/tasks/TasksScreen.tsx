                    ...
                    >
                      ...
                      <td className="py-3.5 px-4">
                        ...
                        <span className="text-[10px] text-neutral-400 uppercase font-mono block">
                          {t.projectName.substring(0, 3).toUpperCase()}-{t.id.substring(t.id.length - 3)}
                        </span>
                      </td>
              ...
              {todoTasks.map(t => (
                ...
                >
                  ...
                  <div className="flex justify-between items-center pt-2 border-t border-neutral-100 dark:border-neutral-700 text-[10px] font-mono text-neutral-400">
                    ...
                    <img src={users[0]?.avatarUrl} alt="" className="w-4 h-4 rounded-full" />
                  </div>
                </div>
              ))}
            </div>
                ...
                >
                  <div className="flex justify-between items-center text-[10px] font-mono">
                    <div className="flex items-center gap-1.5">
                      ...
                      <span className="px-2 py-0.5 rounded bg-red-100 text-red-700 font-bold">Critical</span>
                    </div>
                  ...
                  <div className="flex justify-between items-center pt-2 border-t border-neutral-100 dark:border-neutral-700 text-[10px] font-mono text-neutral-400">
                    ...
                    <span className="font-bold text-neutral-700 dark:text-neutral-300">AL +1</span>
                  </div>
                </div>
              ))}
            </div>
            ...
            <table className="w-full text-left text-xs border-collapse">
              ...
              <tbody className="divide-y divide-neutral-100 dark:divide-neutral-800">
                ...
                <tr>
                  ...
                  <td className="py-3 px-4 border-l border-neutral-200 dark:border-neutral-800 text-center text-neutral-400">
                    —
                  </td>
                </tr>
